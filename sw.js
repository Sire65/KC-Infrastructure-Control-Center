const CACHE='kicc-0.1.0-dev.72';
const CORE=['./','./index.html','./styles.css','./app.js','./navigation/leitstand-tabs.js','./dashboard/instrument-panel.css','./dashboard/instrument-panel.js','./dashboard/dashboard-polish.js','./live/live-console.js','./live/dataflow-topology.js','./programs/remote-heartbeat-server-readiness.js','./programs/remote-heartbeat-bridge-runtime.js','./programs/remote-heartbeat-bridge-ui.js','./auth/runtime-auth-provider.js','./update/pwa-update-manager.js'];
