const CACHE='kicc-0.1.0-dev.4';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./adapters/adapter-core.js','./adapters/github-repository-adapter.js','./adapters/indexeddb-local-adapter.js','./database/database-model.js'];
