const CACHE='kicc-0.1.0-dev.3';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./adapters/adapter-core.js','./adapters/github-repository-adapter.js'];
