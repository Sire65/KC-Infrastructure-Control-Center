...
const PROGRAMS=[
  ...
  Object.assign(makeKcProduct({id:'kc-pc-manager',name:'KC PC Manager',repo:'Kasse',kind:'PC_MANAGER',critical:true,notes:'Als eigene KC-Anwendung geführt; Quellbestand liegt derzeit innerhalb der MarktKasse-Suite.',dependencies:{databases:['db-supabase-core'],communication:['kc-communication'],failover:['flow-supabase-neon-core']}}),{sourceState:'RESTORE_PREPARED',sourceDetail:'Restore-Blöcke vollständig im Repo; automatischer Restore-/Prüfrunner und KICC-Heartbeat-Bootstrap vorbereitet.'}),
  Object.assign(makeKcProduct({id:'kc-money-butler',name:'KC Money Butler',repo:'Kasse',kind:'MONEY_BUTLER',notes:'Als eigene KC-Anwendung geführt; Quellbestand liegt derzeit innerhalb der MarktKasse-Suite.'}),{sourceState:'SOURCE_READY',sourceDetail:'Lesbarer Quellstand unter markt-kasse-suite/money-butler vorhanden.'}),
